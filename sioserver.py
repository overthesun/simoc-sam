...
allowed_origins = ['http://localhost:8080', 'http://localhost:8081',
                   'http://localhost:8080/client', 'http://localhost:8080/sensor',
                   'http://localhost:8081/client', 'http://localhost:8081/sensor']
...
async def emit_to_subscribers(*args, **kwargs):
    for client_id in SUBSCRIBERS:
        await sio.emit(*args, to=client_id, namespace='/client', **kwargs)
