...
async def test_siowrapper(sensor):
    ...
    await siowrapper.start(8080, "localhost")
    ...
    sensor_info = {'location': None, 'sensor_type': 'TestSensor', 'sensor_name': None,
                   'sensor_desc': None, 'serial_number': None, 'reading_info': INFO}
