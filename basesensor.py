...
class BaseSensor(ABC):
    """The base class all Sensors should inherit from."""
    def __init__(self, read_interval=1, batch_size=10, verbose=False):
        self.read_interval = read_interval  # how many seconds between readings
        self.batch_size = batch_size  # how many reads in a batch
...
class MockSensor(BaseSensor):
    ...
    def __init__(self, read_interval=1, batch_size=10, verbose=False,
        ...
        super().__init__(read_interval=read_interval, batch_size=batch_size,
                         verbose=verbose)
    ...
    def read_sensor_data(self):
        ...
        self.print(f'CO2: {self.co2_ppm:4.0f}ppm; Temperature: '
